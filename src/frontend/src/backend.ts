...
export class Backend implements backendInterface {
    ...
    async getGoldPrice(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getGoldPrice();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateGoldPrice(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGoldPrice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "mens" in value ? Category.mens : "collections" in value ? Category.collections : "necklaces" in value ? Category.necklaces : "earrings" in value ? Category.earrings : "rings" in value ? Category.rings : "bracelets" in value ? Category.bracelets : value;
}
